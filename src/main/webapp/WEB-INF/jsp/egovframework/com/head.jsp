                ...
                <nav class="nav">
                    <ul class="menu">
					      ...
					      <li>
	                        ...
	                        <li style="width:100px;"><a href="<c:url value='/uat/uia/egovLoginUsr.do'/>" style="font-size:12px"> 로그인 </a> </li>
			                <li style="width:100px;"><a href="#" style="font-size:12px"> Languages </a> </li>
					    </ul>
                </nav>
            </div>
        </header><!--header end-->
