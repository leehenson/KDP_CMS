						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[개방공간] 1인 미디어 스튜디오 사용 매뉴얼  </a> <i class="fa fa-download"
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[공유장비] 오큘러스 퀘스트2, 홀로렌즈2 사용 매뉴얼 </a> <i
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">	
										[개방공간] 메타버스 체험존 사용 매뉴얼 </a> <i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
							<td class="td_name sv_use"><span class="sv_member">관리자</span></td>
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[개방공간] XR 스튜디오 사용 매뉴얼 </a> <i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
							<td class="td_name sv_use"><span class="sv_member">관리자</span></td>
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[개방공간] 오픈 오피스 사용 매뉴얼 </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										순천대학교 KDP 홈페이지 예약 매뉴얼  </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
