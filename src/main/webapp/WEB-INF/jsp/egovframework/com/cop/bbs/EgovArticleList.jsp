...
<!-- 			</div> -->
	...
	<div id="bo_list">
		<h1
			...
			<span style="font-size: 26px; border-bottom: 4px solid #004483; padding-bottom: 3px;">
				공지사항
			</span>
		</h1>
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[K-디지털 플랫폼] 1인 미디어실 체험 후기 영상 </a> <i class="fa fa-download"
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[순천대학교] Microsoft 재직자와 함께하는 비전공자를 위한 커리어 개발 토크 </a> <i
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										메타버스를 위한 HoloLens2(홀로렌즈) 재직자 교육 </a> <i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
							<td class="td_name sv_use"><span class="sv_member">관리자</span></td>
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										K-디지털 플랫폼 디지털확산 세미나 'Meet, AI' </a> <i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
							<td class="td_name sv_use"><span class="sv_member">관리자</span></td>
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										2023 순천대학교 산학협력 협약식 </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										의료/헬스케어 VR 기술 시연 </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
						...
						<tr class=" even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										[순천대학교] 메타버스 기초 소양 과정 교육 </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
						...
						<tr class=" ">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										2022 K-디지털 플랫폼 개소식 </a> <i class="fa fa-heart"
										aria-hidden="true"></i><i class="fa fa-link"
										aria-hidden="true"></i>
								</div>
							</td>
						...
						<tr class="even">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										K-디지털 플랫폼 예약 시 필독 사항 </a> <i class="fa fa-heart"
						...
						<tr class="">
							...
							<td class="td_subject" style="padding-left: 0px">
								<div class="bo_tit">
									<a
										href="#">
										K-디지털 트레이닝 홈페이지 개설 </a> <i class="fa fa-heart" aria-hidden="true"></i><i
										class="fa fa-link" aria-hidden="true"></i>
								</div>
							</td>
							<td class="td_name sv_use"><span class="sv_member">관리자</span></td>
